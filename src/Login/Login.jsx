    ...
    <div className='loginContainer'>
      ...
      <div className='formContainer'>
        ...
        <form className='loginForm' onSubmit={handleSubmit(onSubmit)}>
          <label>
            <p>userName</p>
            <input id="userName" type="text" name="userName" placeholder='Write your userName soldier' autoComplete='off' {...register("userName", { required: true})} />
          </label>

          <label>
            <p>Password</p>
            <input type="text" id="password" name="password" placeholder='Write your funny password'  autoComplete='off'  {...register("password", { required: true, pattern: /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,12}$/}
)} />
          </label>
